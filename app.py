...
# Цей вебклієнт є частиною навчальних матеріалів для розробників системи "Трембіта".
# Вебклієнт, як приклад, додає до згенерованих запитів всі необхідні HTTP-заголовки, обробки запиту системою "Трембіта".
